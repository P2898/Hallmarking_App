      ...
      <div className={cn(
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-gray-800">
          <div className="flex items-center gap-3 overflow-hidden whitespace-nowrap">
            <div className="w-8 h-8 rounded bg-gold flex items-center justify-center font-bold text-dark flex-shrink-0">
              MX
            </div>
            {(!isOpen ? "md:hidden" : "") && <span className="font-bold text-xl text-gold">MachineXchange</span>}
          </div>
